...
import com.lx.talcar.databinding.FragmentPhoto3Binding
...
class FragmentPhoto3 : Fragment() {
    ...
    private  var _binding: FragmentPhoto3Binding? =null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = FragmentPhoto3Binding.inflate(inflater, container, false)
        ...
        _binding?.leftPhotoTab?.setOnClickListener {
            takePicture()
        }
...
//       loadImageFromFile(outputFile.absolutePath)
    ...
    private fun loadImageFromFile(imagePath: String) {
        ...
        val targetWidth: Int = _binding?.leftPhotoTab?.width!!
        val targetHeight: Int = _binding?.leftPhotoTab?.height!!
        ...
        BitmapFactory.decodeFile(imagePath, bmOptions)?.also { bitmap ->
            binding.leftPhotoTab.setImageBitmap(bitmap)
        }
