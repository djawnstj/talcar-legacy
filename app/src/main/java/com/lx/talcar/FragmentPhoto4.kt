...
import com.lx.talcar.databinding.FragmentPhoto4Binding
...
class FragmentPhoto4 : Fragment() {
    ...
    private  var _binding: FragmentPhoto4Binding? =null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = FragmentPhoto4Binding.inflate(inflater, container, false)
        ...
        _binding?.rightPhotoTab?.setOnClickListener {
            takePicture()
        }
...
//       loadImageFromFile(outputFile.absolutePath)
    ...
    private fun loadImageFromFile(imagePath: String) {
        ...
        val targetWidth: Int = _binding?.rightPhotoTab?.width!!
        val targetHeight: Int = _binding?.rightPhotoTab?.height!!
        ...
        BitmapFactory.decodeFile(imagePath, bmOptions)?.also { bitmap ->
            binding.rightPhotoTab.setImageBitmap(bitmap)
        }
